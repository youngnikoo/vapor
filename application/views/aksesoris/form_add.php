<div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="<?= site_url('CAksesoris/savebarang')?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Deksripsi</label>
                      <div class="col-sm-9">
                        <input type="text" name="desc_produk" class="form-control" id="exampleInputEmail2" placeholder="Deskripsi">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Stok</label>
                      <div class="col-sm-9">
                        <input type="text" name="stok" class="form-control" id="exampleInputMobile" placeholder="Stok">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Stok</label>
