      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Welcome To, <span class="text-black fw-bold">Kongkow Vapor</span></h1>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Daftar Barang</li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= site_url('CDevice') ?>">Device</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= site_url('CLiquid') ?>">Liquid</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= site_url('CAksesoris') ?>">Aksesoris</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              ...
              <span class="menu-title">Jasa Kirim</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="<?= site_url('CJasakirim') ?>">Kurir</a></li>
              </ul>
            </div>
            <li class="nav-item">
              <a class="nav-link" href="<?= site_url('CTransaksi') ?>">
